...
def init_db():
    ...
    # Documents belong to the user's Knowledge Base,
    # not to an individual conversation.
    cur.execute("""
        UPDATE documents
...
def list_documents(user_id, conversation_id=None):
    ...
    conversation_id is kept only for API compatibility.
    It intentionally does not filter the collection.
    """
...
# ============================================================
# IMPORTANT FIX
# View Chunks uses this function.
# ============================================================

def get_document_chunks(doc_id, user_id):
    """
    Return all chunks belonging to one document.

    Security:
    The document must belong to the logged-in user.
    This prevents one user from reading another user's chunks.
    """
...
def get_chunks_for_conversation(conversation_id):
    ...
    Older versions attached documents to conversations.
    Current RAGORA keeps documents at user Knowledge Base level.
    """
...
def user_document_stats(user_id):
    """
    Return total documents and total chunks
    across the user's complete Knowledge Base.
    """
